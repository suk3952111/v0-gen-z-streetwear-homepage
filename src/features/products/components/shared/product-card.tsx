...
export function ProductCard({
  ...
  return (
    <div
      ...
      className="group relative isolate border-4 border-[#CCFF00] bg-[#0a0a0a] transition-all hover:translate-x-1 hover:-translate-y-1 hover:shadow-[8px_8px_0px_#CCFF00]"
    >
      <button
      ...
      <div className="px-4 pb-4">
        <div className="flex items-center justify-between">
          <p className="text-[#CCFF00] text-2xl font-bold">{formatPriceByCurrency(price, currency)}</p>
          <button
