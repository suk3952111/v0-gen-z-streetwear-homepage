    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      ...
      <style jsx>{`
        ...
        @keyframes glitch-404-slice {
          0%, 100% { clip-path: inset(45% 0 25% 0); transform: translate(5px, -3px); }
          20% { clip-path: inset(15% 0 55% 0); transform: translate(-5px, 2px); }
          45% { clip-path: inset(55% 0 15% 0); transform: translate(4px, -1px); }
          70% { clip-path: inset(25% 0 45% 0); transform: translate(-3px, 3px); }
        }
      `}</style>
    </div>
  )
